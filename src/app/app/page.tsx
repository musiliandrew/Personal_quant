  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <motion.div
        ...
        className="glass mt-4 sm:mt-6 rounded-[24px] sm:rounded-[28px] p-4 sm:p-5 border border-foreground/[0.08]"
      >
      ...
      <motion.div
        ...
        className="soft-card mt-4 sm:mt-6 rounded-[24px] sm:rounded-[28px] p-4 sm:p-5"
      >
      ...
      <motion.div
        ...
        className={`glass mt-4 sm:mt-6 rounded-[24px] sm:rounded-[28px] p-4 sm:p-5 border border-foreground/[0.08] relative transition-all duration-300 ${
          showOnboardingTour 
      ...
      <motion.div
        ...
        className="glass mt-4 sm:mt-6 rounded-[24px] sm:rounded-[28px] p-4 sm:p-5"
      >
        <div className="flex items-center justify-between">
          <div>
